...
assertEquals(contract.balanceOf(me, 1).toNumber(), 50, "PartyToken 0 should have balance 0 before activation");
assertEquals(contract.balanceOf(me, 2).toNumber(), 50, "PartyToken 2 should have balance 0 before activation");
