...
log_big("BettingExampleNewScale_ test.");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 20, "PT2 balance 20 after transfer of PT1");
...
assertEquals(contract.balanceOf(me, 1).toNumber(), 0, "PT0 balance 0 after burn(19)");
assertEquals(contract.balanceOf(me, 2).toNumber(), 1, "PT1 balance 1 after burn(19)");
