...
./compile_and_deploy.pl out DeepNestedContractMultiplePayoutsMultipleAssets1/DeepNestedContractMultiplePayoutsMultipleAssets1.dag > /dev/null
# prepend lib to every test-set
cat lib.js DeepNestedContractMultiplePayoutsMultipleAssets1/DeepNestedContractMultiplePayoutsMultipleAssets1.js > out/test.js
