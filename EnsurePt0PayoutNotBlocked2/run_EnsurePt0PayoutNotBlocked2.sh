...
./compile_and_deploy.pl out EnsurePt0PayoutNotBlocked2/EnsurePt0PayoutNotBlocked2.dag > /dev/null
# prepend lib to every test-set
cat lib.js EnsurePt0PayoutNotBlocked2/EnsurePt0PayoutNotBlocked2.js > out/test.js
