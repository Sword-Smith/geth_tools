...
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PartyToken 2 balance should have balance 5 after activation");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PartyToken 2 balance should still be 5");
assertEquals(Erc20_CHF.balanceOf(me).toNumber(), 19900, "Settlement asset should have balance 19,900 after activation");
...
assertEquals(contract.balanceOf(me, 1).toNumber(), 7, "PartyToken 1 balance should still be 7");
assertEquals(contract.balanceOf(me, 2).toNumber(), 7, "PartyToken 2 balance should be 7");
...
assertEquals(contract.balanceOf(me, 1).toNumber(), 10, "PartyToken 1 balance should still be 7");
assertEquals(contract.balanceOf(me, 2).toNumber(), 10, "PartyToken 2 balance should be 7");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 10, "PartyToken 2 balance unaffected by failed zero-burn");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 10, "PartyToken 2 balance unaffected by failed burn");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PartyToken 2 balance is lower after 1st burn");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PartyToken 2 balance unaffected by failed 2nd burn");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 0, "PartyToken 2 balance is lower after 2nd (full) burn");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 0, "PartyToken 2 balance unaffected by failed zero-burn");
...
// Test burning with unequal PT balances (balance(PT1) != balance(PT2), where balance(PT1) < balance(PT2)
do_approve(200, 3000000, contract.address);
succ(do_mint(contract, 10), "Allow the minting of 10 additional PT pairs for balance(PT1) < balance(PT2) tests");
succ(do_transfer(contract, me, other, 1, 5), "Allow me to transfer away 5 PT1s");
assertEquals(contract.balanceOf(me, 1).toNumber(), 5, "PartyToken 1 balance 5 after mint of 10 and transferred away 5");
assertEquals(contract.balanceOf(me, 2).toNumber(), 10, "PartyToken 2 is 10 after mint of 10");

succ(do_burn(contract, 3), "Burn 3 PT token pairs when balance is 5/10");
assertEquals(contract.balanceOf(me, 1).toNumber(), 2, "PartyToken 1 balance is 2 after 5 transferred and 3 was burned");
assertEquals(contract.balanceOf(me, 2).toNumber(), 7, "PartyToken 2 balance is 7 after 3 was burned");

fail(do_burn(contract, 3), "Fail the burn of 3 PT token pairs when balance is 2/7");
assertEquals(contract.balanceOf(me, 1).toNumber(), 2, "PartyToken 1 balance is 2 after failed burn for partial balance insufficiency");
assertEquals(contract.balanceOf(me, 2).toNumber(), 7, "PartyToken 2 balance is 7 after failed burn for partial balance insufficiency");

succ(do_burn(contract, 2), "Succeed burn when balance is 2/7");
assertEquals(contract.balanceOf(me, 1).toNumber(), 0, "PT1 balance is 0 after succeeded burn when balance is 2/7");
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PT2 balance is 5 after succeeded burn when balance is 2/7");

fail(do_burn(contract, 1), "Cannot burn anything when PT1 balance is 0");
assertEquals(contract.balanceOf(me, 1).toNumber(), 0, "PT1 balance unaffected by failed burn 3.");
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PT2 balance unaffected by failed burn 3.");

fail(do_burn(contract, 0), "Cannot burn 0 when PT1 balance is 0");
assertEquals(contract.balanceOf(me, 1).toNumber(), 0, "PT1 balance unaffected by failed burn 4.");
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PT2 balance unaffected by failed burn 4.");

// Test burning with unequal PT balances (balance(PT1) != balance(PT1), where balance(PT1) > balance(PT1)
// First get rid of all PTs
succ(do_transfer(contract, me, other, 2, 5), "Allow me to get rid of last PT2s");

do_approve(200, 3000000, contract.address);
succ(do_mint(contract, 10), "Allow the minting of 10 additional PT pairs for balance(PT1) > balance(PT2) tests");
succ(do_transfer(contract, me, other, 2, 5), "Allow me to transfer away 5 PT2s, b_PT1 > b_PT2");

assertEquals(contract.balanceOf(me, 1).toNumber(), 10, "PartyToken 1 is balance 10 after mint of 10, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PartyToken 2 is 5 after mint of 10 and transfer of 5, b_PT1 > b_PT2");

succ(do_burn(contract, 3), "Burn 3 PT token pairs when balance is 10/5, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 1).toNumber(), 7, "PartyToken 1 balance is 7 after 3 was burned, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 2).toNumber(), 2, "PartyToken 2 balance is 2 after 5 transferred and 3 was burned, b_PT1 > b_PT2");

fail(do_burn(contract, 3), "Fail the burn of 3 PT token pairs when balance is 7/2, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 1).toNumber(), 7, "PartyToken 1 balance is 7 after failed burn for partial balance insufficiency, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 2).toNumber(), 2, "PartyToken 2 balance is 2 after failed burn for partial balance insufficiency, b_PT1 > b_PT2");

succ(do_burn(contract, 2), "Succeed burn when balance is 7/2, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 1).toNumber(), 5, "PT1 balance is 5 after succeeded burn when balance is 7/2, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 2).toNumber(), 0, "PT2 balance is 0 after succeeded burn when balance is 7/2, b_PT1 > b_PT2");

fail(do_burn(contract, 1), "Cannot burn anything when PT2 balance is 0, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 1).toNumber(), 5, "PT1 balance unaffected by failed burn 5., b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 2).toNumber(), 0, "PT2 balance unaffected by failed burn 5., b_PT1 > b_PT2");

fail(do_burn(contract, 0), "Cannot burn 0 when PT1 balance is 0, b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 1).toNumber(), 5, "PT1 balance unaffected by failed burn 6., b_PT1 > b_PT2");
assertEquals(contract.balanceOf(me, 2).toNumber(), 0, "PT2 balance unaffected by failed burn 6., b_PT1 > b_PT2");
