...
var contract = PayoutLessThanMaxFactor_;
log_big("PayoutLessThanMaxFactor_ test.");
...
assertEquals(contract.balanceOf(me, pt2).toNumber(), 47, "PartyToken 2 balance is 47, #1");
...
// Evaluate PT0 postition, from `other` account. Will succeed since both PT1 and PT2 payouts were evaluated when 1st pay() call was made
