...
assertEquals(contract.balanceOf(me, 2).toNumber(), 50, "PT2 balance is 50 after activation");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 50, "PT2 balance is still 50 after failed and overflowed pay()");
...
assertEquals(contract.balanceOf(me, 2).toNumber(), 0, "PT2 balance is 50 after succeeded pay()");
