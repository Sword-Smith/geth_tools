...
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PT2 balance is correct after activation");
...
assertEquals(contract.balanceOf(me, 1).toNumber(), 5, "PT1 balance is unaffected by failed pay");
assertEquals(contract.balanceOf(me, 2).toNumber(), 5, "PT2 balance is unaffected by failed pay");
...
assertEquals(contract.balanceOf(me, 1).toNumber(), 0, "PT1 balance is zero after successful pay");
assertEquals(contract.balanceOf(me, 2).toNumber(), 0, "PT2 balance is zero after successful pay");

do_set(DataFeed1_, 0);
succ(do_mint(contract, 5), "mint(1)");
succ(do_pay(contract, contract_address), "Allow 0/1 calculation");
assertEquals(contract.balanceOf(me, 1).toNumber(), 0, "PT1 balance is zero after successful pay, 2");
assertEquals(contract.balanceOf(me, 2).toNumber(), 0, "PT2 balance is zero after successful pay, 2");
