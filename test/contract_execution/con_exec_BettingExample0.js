...
// Derivative Contract
t_contract = BettingExample0_.address;
console.log("BettingExample0_ address is: " + t_contract);
...
var balance_EUR = Tmc4_EUR.balanceOf(me);
console.log("EUR: My balance is now: " + balance_EUR);
console.log("EUR: Now executing contract BettingExample0_");
var execute_transaction = BettingExample0_.execute({from: me, gas: 3000000} );
...
console.log("The value of the data feed obs() is: " + DataFeed0_.get(101));
