...
// Derivative Contract
t_contract = TestObs0_.address;
console.log("TestObs0_ address is: " + t_contract);
...
var set_tr = DataFeed0_.set( 101, 42, {from: me, gas: 3000000} );
...
var balance_EUR = Tmc4_EUR.balanceOf(me);
console.log("EUR: My balance is now: " + balance_EUR);
console.log("EUR: Now executing contract TestObs0_");
var execute_transaction = TestObs0_.execute({from: me, gas: 3000000} );
