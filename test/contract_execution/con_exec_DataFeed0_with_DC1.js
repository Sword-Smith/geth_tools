...
// Derivative Contract
t_contract = TestObs1_.address;
console.log("TestObs1_ address is: " + t_contract);
...
var set_tr = DataFeed0_.set( 101, 45, {from: me, gas: 3000000} );
...
var b_EUR = Tmc4_EUR.approve( t_contract, 10000, {from: me, gas: 3000000} );
...
var balance_EUR = Tmc4_EUR.balanceOf(me);
console.log("EUR: My balance is now: " + balance_EUR);
console.log("EUR: Now executing contract TestObs1_");
var execute_transaction = TestObs1_.execute({from: me, gas: 3000000} );
