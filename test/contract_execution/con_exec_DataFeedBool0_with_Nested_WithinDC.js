...
var balance_EUR = Tmc4_EUR.balanceOf(me);
console.log("EUR: My balance is now: " + balance_EUR);
console.log("EUR: Now executing contract TestNestedIfWithin");
var execute_transaction = TestNestedIfWithin.execute({from: me, gas: 3000000} );
...
var balance_EUR = Tmc4_EUR.balanceOf(me);
// First time this should be 999
// When the time runs out, this should be 957
console.log("EUR: My balance is now: " + balance_EUR);

// Derivative Contract
t_contract = TestNestedIfWithin.address;
console.log("TestNestedIfWithin address is: " + t_contract);
code = web3.eth.getCode(t_contract);
console.log("The code present on this address: " + code );
