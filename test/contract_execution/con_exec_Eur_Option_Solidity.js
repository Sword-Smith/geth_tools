...
// Derivative Contract
t_contract = Eur_option_.address;
console.log("Eur_option_ address is: " + t_contract);
...
var balance_EUR = Tmc4_EUR.balanceOf(me);
console.log("EUR: My balance is now: " + balance_EUR);
console.log("EUR: Now executing contract Eur_option_");
var execute_transaction = Eur_option_.execute({from: me, gas: 3000000} );
