...
t_contract = NewScaleAndExp_.address;
console.log("NewScaleAndExp_ address is: " + t_contract);
...
console.log("EUR & USD: Now executing contract NewScaleAndExp_");
var execute_transaction = NewScaleAndExp_.execute({from: me, gas: 3000000} );
