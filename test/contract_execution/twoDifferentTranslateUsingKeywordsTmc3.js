...
t_contract = twoDifferentTranslateUsingKeywordsTmc3_.address;
console.log("twoDifferentTranslateUsingKeywordsTmc3_ address is: " + t_contract);
code = web3.eth.getCode(t_contract);
console.log("The code present on this address: " + code );
tmc_address_EUR = Tmc3_EUR.address;
console.log("EUR: The Tmc3 address is: " + tmc_address_EUR);
var balance_EUR = Tmc3_EUR.balanceOf(me);
console.log("EUR: My balance is now: " + balance_EUR);
var allowance_EUR = Tmc3_EUR.allowance(me, t_contract, {from: me, gas: 3000000});
...
var b_EUR = Tmc3_EUR.approve( t_contract, 500, {from: me, gas: 3000000} );
...
var allowance1_EUR = Tmc3_EUR.allowance(me, t_contract, {from: me, gas: 3000000} );
console.log("EUR: The allowance is: " + allowance1_EUR);
var totalLockedAmount1_EUR = Tmc3_EUR.totalLockedAmount(me);
console.log("EUR: The totalLockedAmount method returns: " + totalLockedAmount1_EUR);
var spenderToApproval1_EUR = Tmc3_EUR.spenderToApproval(t_contract);
console.log("EUR: The spenderToApproval method returns: " + spenderToApproval1_EUR);

// Allow contract to transfer 500 of my money
console.log('USD: Now calling "approve"');
var b_USD = Tmc3_USD.approve( t_contract, 500, {from: me, gas: 3000000} );
...
var allowance1_USD = Tmc3_USD.allowance(me, t_contract, {from: me, gas: 3000000} );
console.log("USD: The allowance is: " + allowance1_USD);
var totalLockedAmount1_USD = Tmc3_USD.totalLockedAmount(me);
console.log("USD: The totalLockedAmount method returns: " + totalLockedAmount1_USD);
var spenderToApproval1_USD = Tmc3_USD.spenderToApproval(t_contract);
...
console.log("EUR & USD: Now executing contract twoDifferentTranslateUsingKeywordsTmc3_");
var execute_transaction = twoDifferentTranslateUsingKeywordsTmc3_.execute({from: me, gas: 3000000} );
